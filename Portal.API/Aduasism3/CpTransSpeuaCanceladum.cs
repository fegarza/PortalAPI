...
{
    [Table("cp_trans_speua_cancelada")]
    public partial class CpTransSpeuaCanceladum
    {
        [Key]
        ...
        [Column("status_trans_speua", TypeName = "numeric(1, 0)")]
        public decimal StatusTransSpeua { get; set; }
        [Column("status_contable", TypeName = "numeric(1, 0)")]
        public decimal? StatusContable { get; set; }
        [Column("fecha_trans_speua", TypeName = "datetime")]
        public DateTime? FechaTransSpeua { get; set; }
